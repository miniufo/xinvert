...
ds = open_CtlDataset('D:/Data/Interest/EPFlux/flx.ctl')

u = ds.uwnd.where(ds.uwnd!=ds.undef)[0]
v = ds.vwnd.where(ds.vwnd!=ds.undef)[0]
h = ds.hgt.where(ds.hgt!=ds.undef)[0]
...
sf2 = invert_Poisson(frc2, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-11,
                    optArg=None,
                    cal_flow=False,
...
sf3 = invert_Poisson(frc3, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-11,
                    optArg=None,
                    cal_flow=False,
...
sf4 = invert_Poisson(frc4, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sf5 = invert_Poisson(frc5, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sf9 = invert_Poisson(frc9, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sf10 = invert_Poisson(frc10, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sf11 = invert_Poisson(frc11, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sf12 = invert_Poisson(frc12, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sfb = invert_Poisson(frcAll-frcAll, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
sf = invert_Poisson(frcAll, dims=['lat','lon'], BCs=['fixed', 'periodic'],
                    mxLoop=5000,
                    tolerance=1e-12,
                    optArg=None,
                    cal_flow=False,
...
ax = axes[0,1]
p=ax.contourf(sf2/9.81, cmap='jet', levels=np.linspace(-30, 30,25))
...
ax = axes[1,1]
p=ax.contourf(sf3/9.81, cmap='jet', levels=np.linspace(-30, 30,25))
...
ax = axes[2,1]
p=ax.contourf(sf4/9.81, cmap='jet', levels=np.linspace(-30, 30,25))
...
ax = axes[3,1]
p=ax.contourf(sf5/9.81, cmap='jet', levels=np.linspace(-30, 30,25))
...
ax = axes[4,1]
p=ax.contourf(sf9/9.81, cmap='jet', levels=np.linspace(-2000, 0,21))
...
ax = axes[5,1]
p=ax.contourf(sf10/9.81, cmap='jet', levels=np.linspace(1500, 2300,17))
...
ax = axes[6,1]
p=ax.contourf(sf11/9.81, cmap='jet', levels=np.linspace(0, 46,24))
...
ax = axes[7,1]
p=ax.contourf(sf12/9.81, cmap='jet', levels=np.linspace(-12, 12,25))
...
ax = axes[8,1]
p=ax.contourf(sfb/9.81, cmap='jet', levels=np.linspace(5074, 5100,27))
...
ax = axes[9,1]
p=ax.contourf(sf/9.81, cmap='jet', levels=np.linspace(4800, 6000,25))
...
ax = axes[0,0]
p=ax.contourf((sf9+sf10+sfb)/9.81, cmap='jet', levels=np.linspace(4800, 6000,25))
ax.set_title('forcing 9+10+bdy', fontsize=fontsize)
ax.set_ylim([-80, 80])
ax.set_xlim([-180, 180])
ax.colorbar(p, loc='b', length=1)

ax = axes[1,0]
p=ax.contourf((sf9+sf10+sf11+sf12+sfb)/9.81, cmap='jet', levels=np.linspace(4800, 6000,25))
...
ax = axes[2,0]
p=ax.contourf((sf2+sf3+sf4+sf5+sf9+sf10+sf11+sf12+sfb)/9.81, cmap='jet', levels=np.linspace(4800, 6000,25))
